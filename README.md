...
## Оглавление
1. [Сценарий перехода к форме записи на курс "Инженер по тестированию"]([1.](https://github.com/KnifeRing/Test_plan?tab=readme-ov-file#1-сценарий-перехода-к-форме-записи-на-курс-инженер-по-тестированию))
